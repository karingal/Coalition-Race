...
bin/cRace: bin/main.o bin/Agent.o bin/EdgeWeightSelectionPolicy.o bin/Graph.o bin/LastOfferJoinPolicy.o bin/MandatesJoinPolicy.o bin/MandatesSelectionPolicy.o bin/Parser.o bin/Party.o bin/Simulation.o
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/EdgeWeightSelectionPolicy.o bin/Graph.o bin/LastOfferJoinPolicy.o bin/MandatesJoinPolicy.o bin/MandatesSelectionPolicy.o bin/Parser.o bin/Party.o bin/Simulation.o
